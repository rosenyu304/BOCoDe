...
def main() -> None:
    ...
    parser.add_argument(
        ...
        type=int,
        default=50,
        help="function-eval budget beyond the init design",
    )
    parser.add_argument("--batch_size", type=int, default=5, help="DGEMO batch size b")
    parser.add_argument(
        "--pop_size", type=int, default=100, help="NSGA-II population size"
    )
    parser.add_argument(
        "--n_gen",
        type=int,
        default=50,
        help="NSGA-II generations for Pareto approximation",
    )
