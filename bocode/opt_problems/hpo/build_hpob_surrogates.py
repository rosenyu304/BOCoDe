...
Measured: saussure ran xgboost 3.3.0, the workers 3.2.0. Worker-produced results re-evaluated on
saussure disagreed by up to 4e-3 ON THE INITIAL DESIGN -- i.e. before any BO had happened. 181
results were invalidated by this.
