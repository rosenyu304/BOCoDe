"""Constrained Hartmann synthetic test function (6-D, 1 constraint), negated to maximize.
...
class ConstrainedHartmann(ConstrainedSingleObjSyntheticProblem):
    """Hartmann (6-D) with a single norm constraint ``||x|| <= 1`` (feasible <= 0)."""

    available_dimensions = 6
    num_constraints = 1
    botorch_cls = _syn.ConstrainedHartmann
