...
class CarContinuous(Car):
    """Fully-continuous relaxation of Car: all 11 variables continuous, 10 inequality
    constraints. A well-posed SO-constrained engineering problem (feasible region ~8% by
    volume)."""

    tags = {"single_objective", "constrained", "11D", "continuous"}
