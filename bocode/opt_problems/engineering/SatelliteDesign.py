...
_H_TABLE = (
    np.array(
        [100, 150, 200, 250, 300, 350, 400, 450, 500, 550, 600, 650, 700, 750,
         800, 850, 900, 950, 1000, 1250, 1500]
    )
    * 1e3
)
_RHO_TABLE = np.array(
    [4.79e-07, 1.81e-09, 2.53e-10, 6.24e-11, 1.95e-11, 6.98e-12, 2.72e-12,
...
_SCALEHEIGHT_TABLE = (
    np.array(
        [5.9, 25.5, 37.5, 44.8, 50.3, 54.8, 58.2, 61.3, 64.5, 68.7, 74.8, 84.4,
         99.3, 121, 151, 188, 226, 263, 296, 408, 516]
    )
    * 1e3
)
