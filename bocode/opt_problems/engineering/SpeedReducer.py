...
class SpeedReducerContinuous(SpeedReducer):
    """Fully-continuous relaxation of SpeedReducer: all 7 variables continuous, 9 inequality
    constraints. A well-posed SO-constrained engineering problem."""

    tags = {"single_objective", "constrained", "7D", "continuous"}
