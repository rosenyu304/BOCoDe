...
class Ishigami(BotorchProblem):
    ...
    num_constraints = botorch.test_functions.sensitivity_analysis.Ishigami().num_constraints if hasattr(botorch.test_functions.sensitivity_analysis.Ishigami(), 'num_constraints') else 0
...
class Gsobol(BotorchProblem):
    ...
    num_constraints = botorch.test_functions.sensitivity_analysis.Gsobol(dim=6).num_constraints if hasattr(botorch.test_functions.sensitivity_analysis.Gsobol(dim=6), 'num_constraints') else 0
...
class Morris(BotorchProblem):
    ...
    num_constraints = botorch.test_functions.sensitivity_analysis.Morris().num_constraints if hasattr(botorch.test_functions.sensitivity_analysis.Morris(), 'num_constraints') else 0
