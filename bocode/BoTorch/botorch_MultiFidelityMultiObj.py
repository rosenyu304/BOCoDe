...
class MOMFBraninCurrin(MultiObjBotorchProblem):
    ...
    num_objectives = 2
    num_constraints = botorch.test_functions.multi_objective_multi_fidelity.MOMFBraninCurrin().num_constraints if hasattr(botorch.test_functions.multi_objective_multi_fidelity.MOMFBraninCurrin(), 'num_constraints') else 0
...
class MOMFPark1(MultiObjBotorchProblem):
    ...
    num_objectives = 2
    num_constraints = botorch.test_functions.multi_objective_multi_fidelity.MOMFPark().num_constraints if hasattr(botorch.test_functions.multi_objective_multi_fidelity.MOMFPark(), 'num_constraints') else 0
