...
class TSP_51Cities(BenchmarkProblem):
    ...
    def _evaluate_implementation(self, X: torch.Tensor) -> Tuple[torch.Tensor, torch.Tensor]:
        ...
        env = TSP(city_loc_list=self.city_loc_list, optimum_tour_city=None, episode_length=2, method='ppo')
...
class TSP_100Cities(BenchmarkProblem):
    ...
    def __init__(self):
        # 100 cities
        self.city_loc_list = [[-47,2],[49,-21 ],[35,-47 ],[30,-47 ],[-39,-50] ,[-35,-27],[-34,9 ],[-11,-8 ],[32,-44 ],[ 1,35 ],[ 36,37 ]
        ...
        optimum = [1,97,53,51,38,16,7,28,19,46,60,22,84,76,47,86,78,36,74,72,27,80,79,85,21,57,94,15,75,90,71,100,10,12,34
