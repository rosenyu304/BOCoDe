...
from ..botorch_MultiObj import BraninCurrin, DH1, DH2, DH3, DH4, DTLZ1, DTLZ2, DTLZ3, DTLZ4, DTLZ5, DTLZ7, GMM, Penicillin, ToyRobust, VehicleSafety, ZDT1, ZDT2, ZDT3, CarSideImpact, BNH, CONSTR, ConstrainedBraninCurrin, C2DTLZ2, DiscBrake, MW7, OSY, SRN, WeldedBeam
...
@pytest.mark.parametrize("func", [AugmentedBranin, AugmentedHartmann, AugmentedRosenbrock])
def test_botorch_funcs(func):
    general_test(func)

@pytest.mark.parametrize("func", [BraninCurrin, DH1, DH2, DH3, DH4, DTLZ1, DTLZ2, DTLZ3, DTLZ4, DTLZ5, DTLZ7, GMM, Penicillin, ToyRobust, VehicleSafety, ZDT1, ZDT2, ZDT3, CarSideImpact, BNH, CONSTR, ConstrainedBraninCurrin, C2DTLZ2, DiscBrake, MW7, OSY, SRN, WeldedBeam])
